...
const RejectOrderModal: React.FC<RejectOrderModalProps> = ({ isOpen, onClose, onSubmit }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Reject Purchase Order">
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <textarea
            ...
            placeholder="Provide a clear reason for rejecting this order..."
            required
          />
        </div>
